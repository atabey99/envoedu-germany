            ...
            <CardContent className="p-8">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <Label htmlFor="fullName" className="text-sm font-medium text-foreground mb-2">Ad Soyad</Label>
                    <Input
                      id="fullName"
                      type="text"
                  ...
                  <div>
                    <Label htmlFor="phone" className="text-sm font-medium text-foreground mb-2">Telefon</Label>
                    <Input
                      id="phone"
                      type="tel"
                ...
                <div>
                  <Label htmlFor="email" className="text-sm font-medium text-foreground mb-2">E-posta</Label>
                  <Input
                    id="email"
                    type="email"
                ...
                <div>
                  <Label htmlFor="program" className="text-sm font-medium text-foreground mb-2">İlgilendiğiniz Program</Label>
                ...
                <div>
                  <Label htmlFor="message" className="text-sm font-medium text-foreground mb-2">Mesajınız</Label>
                  <Textarea
                    id="message"
                    rows={4}
                ...
                >
                  ...
                  {createConsultationRequest.isPending ? "Gönderiliyor..." : "Randevu Talep Et"}
                </Button>
              </form>
            </CardContent>
          </Card>
